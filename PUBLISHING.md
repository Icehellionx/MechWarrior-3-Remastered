...
```powershell
gh release create v1.2.5 .\dist\MechWarrior-3-Remastered-Setup.exe .\dist\SHA256SUMS.txt .\dist\PAYLOAD_MANIFEST.sha256 --title "MechWarrior 3 Remastered v1.2.5" --notes-file .\release-notes-v1.2.5.md
```
