...
No code or binary from the Pirate's Moon warez/RIP folder or its crack is included. Pirate's Moon is installed only from the optional ISO selected by the user and continues to require that ISO when launched.
